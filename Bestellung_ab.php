...
<head>
    ...
    <title>Webshop f&uuml;r Textilwaren | Bestellung gesendet</title>
    ...
    <div id="topmost">
        ...
        <div id="UeberDiv">
            <div id="ProduktAnzeige" class="abrunden_20 HintergrundGelbVerlauf">
                <label class="TextSchein">Bestellung abgeschlossen</label>
            </div>
            <div id="OverFunction">
               <span class="span600">Ihre Bestellung wurde erfolgreich registriert. Ihnen wurden alle Informationen zur Bestellung per Email zugesandt.</span>
